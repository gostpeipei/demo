...
function butEventHandler(a, b) {
    switch (a) {
        ...
        case "quitFromEnd":
            ...
            console.log('quitFromEnd')
            window.location.href = 'https://itunes.apple.com/us/app/tasty-tale-the-crazy-cooking-puzzle-game/id841415461?mt=8';
            return
...
function initGameOver() {// 游戏结束后初始化游戏并弹出两个按钮
    ...
    var a = {oImgData: assetLib.getData("playBut"),aPos: [963, 465]}, b = {oImgData: assetLib.getData("quitBut"),aPos: [190, 465]};
...
function toggleManualPause() {
    if (manualPause)
        ...
        var a = {oImgData: assetLib.getData("quitBut"),aPos: [190, 465]}, b = {oImgData: assetLib.getData("playBut"),aPos: [963, 465]}, c = new Array(a, b);
